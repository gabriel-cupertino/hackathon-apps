...
def configure_otel():
    ...
    if not endpoint:
        log.info("OTEL_EXPORTER_OTLP_ENDPOINT não definido — tracing desativado")
        return
    try:
        ...
        log.info(f"OTel Distributed Tracing ativado → {endpoint}")
    except Exception as e:
        log.warning(f"OTel não inicializado: {e} — tracing desativado")
